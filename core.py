...
class AsyncGrassWs:
    def __init__(self, user_id, proxy_url=None):
        ...
        self.server_url = "wss://proxy2.wynd.network:4444/"
        self.server_hostname = "proxy2.wynd.network"
        self.logs = []
        self.failed_attempts = 0  # 记录连接失败的次数
        ...
        while True:
            ...
            try:
                ...
                if self.proxy_url:
                    ...
                    await loop.run_in_executor(None, ws_proxy.connect, ("proxy2.wynd.network", 4444))  # 执行阻塞函数
